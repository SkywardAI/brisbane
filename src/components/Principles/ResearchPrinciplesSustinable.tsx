...
const ResearchPrinciplesSustinable = () => {
  return (
    <section id="researchPrinciplesSustinable" className="pt-16 md:pt-20 lg:pt-28">
          ...
          <div className="w-full px-4 lg:w-7/12 xl:w-8/12">
            ...
            >
              <h2 className="mb-3 text-2xl font-bold text-black dark:text-white sm:text-3xl lg:text-2xl xl:text-3xl">
                AI Efficiency & Sustainability
              </h2>
              <p className="mb-6 text-base font-medium text-body-color">
                Building AI responsibly to minimize environmental impact.
              </p>
...
export default ResearchPrinciplesSustinable;